...
export default async function HomePage({ params }: { params: { locale: Locale } }) {
  ...
  return (
    <>
      ...
      {/* CONTACTO */}
      <section id="contacto" className="section-anchor mx-auto max-w-5xl px-6 py-14 sm:py-20">
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          {/* Esquema visual de pasos: rompe el bloque de texto/formulario con
              algo más gráfico y fácil de escanear de un vistazo. */}
          <Reveal delay={80}>
